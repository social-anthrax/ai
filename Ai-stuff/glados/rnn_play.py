...
# structure of a play, unintelligible words
shakespeareC3 = "checkpoints/rnn_train_1495455686-450000"
# better structure of a play, character names (not very good), 4-letter words in correct English
shakespeareC4 = "checkpoints/rnn_train_1495447371-15000000"
# good names, even when invented (ex: SIR NATHANIS LORD OF SYRACUSE), correct 6-8 letter words
shakespeareC5 = "checkpoints/rnn_train_1495447371-45000000"
# ACT V SCENE IV, [Re-enter KING JOHN with MARDIAN], DON ADRIANO DRAGHAMONE <- invented!
...
# some function calls with parameters and ()
pythonA1 = "checkpoints/rnn_train_1495458538-1200000"
# starts looking Tensorflow Python, nested () and [] not perfect yet
pythonA2 = "checkpoints/rnn_train_1495458538-10200000"
# can even recite the Apache license
pythonB10 = "checkpoints/rnn_train_1495458538-201600000"
...
with tf.Session() as sess:
    new_saver = tf.train.import_meta_graph(
        'checkpoints/rnn_train_1495455686-0.meta')
    ...
    for i in range(10000):
        yo, h = sess.run(['Yo:0', 'H:0'], feed_dict={
                         'X:0': y, 'pkeep:0': 1., 'Hin:0': h, 'batchsize:0': 1})
